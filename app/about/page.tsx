...
export const metadata = {
    ...
    description: 'Learn about PuzzlyNest, our mission to provide free, accessible games for all ages.',
};
            ...
            <main className="container" style={{ paddingTop: '2rem', maxWidth: '800px' }}>
                ...
                <section className="card" style={{ padding: '2rem', marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.8)', lineHeight: 1.8 }}>
                        PuzzlyNest was created with a simple goal: provide high-quality, free games that are
                ...
                <section className="card" style={{ padding: '2rem', marginBottom: '2rem' }}>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.8)', lineHeight: 1.8 }}>
                        All games on PuzzlyNest are completely free. We support our platform through
